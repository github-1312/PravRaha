...
export const metadata: Metadata = {
  title: "Go-To-Market Strategy | PravRaha - B2B Sales Intelligence Platform",
  description:
    "PravRaha's GTM platform helps B2B SaaS companies find, enrich, and reach ideal buyers with SDR-led precision. From ICP targeting to booked meetings — all in one place.",
};
